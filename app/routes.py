...
app_bp.route("/reset_password", endpoint="reset_password", methods=["POST"])(
    reset_password
)
...
app_bp.route("/feedback.html", endpoint="send_feedback", methods=["POST"])(
    send_feedback
)
...
app_bp.route("/preview_material", endpoint="preview_material", methods=["GET"])(
    preview_material
)
app_bp.route("/delete_material", endpoint="delete_material", methods=["DELETE"])(
    delete_material
)
app_bp.route("/upload_material", endpoint="upload_material", methods=["POST"])(
    upload_material
)
...
app_bp.route("/public_designs", endpoint="public_designs", methods=["GET"])(
    public_designs
)
app_bp.route("/get_public_designs", endpoint="get_public_designs", methods=["GET"])(
    get_public_designs
)
app_bp.route("/save_design", endpoint="save_design", methods=["POST"])(save_design)
app_bp.route("/get_user_designs", endpoint="get_user_designs", methods=["GET"])(
    get_user_designs
)
app_bp.route("/load_design", endpoint="load_design", methods=["GET"])(load_design)
app_bp.route("/delete_design", endpoint="delete_design", methods=["DELETE"])(
    delete_design
)
app_bp.route("/get_layers", endpoint="get_layers", methods=["GET"])(get_layers)
app_bp.route("/get_color_chart", endpoint="get_color_chart", methods=["POST"])(
    get_color_chart
)

app_bp.route("/subscription", endpoint="subscription", methods=["GET"])(subscription)
app_bp.route("/subscription/checkout", endpoint="subscription_checkout", methods=["POST"])(
    checkout
)
app_bp.route(
